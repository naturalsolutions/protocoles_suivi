DROP VIEW IF EXISTS gn_monitoring.v_export_test_persistance_visit;
CREATE OR REPLACE VIEW gn_monitoring.v_export_test_persistance_visit as
select tm.module_code as protocole,
    ...
    ref_nomenclatures.get_nomenclature_label(
        (tvc.data->>'id_nomenclature_type_cadavre')::integer
    ) as TypeCadavre,
    tvc.data->>'taille' as Taille,
    string_agg(
