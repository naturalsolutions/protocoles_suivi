...
select tm.module_code as protocole,
    ...
    ref_nomenclatures.get_nomenclature_label(
        (toc.data->>'id_nomenclature_type_donnee_gite')::integer
    ) as TypeDonneeGite,
    ref_nomenclatures.get_nomenclature_label(
        (toc.data->>'id_nomenclature_type_effectif')::integer
    ) as TypeEffectif,
    ref_nomenclatures.get_nomenclature_label(
        (toc.data->>'id_nomenclature_presence_juvenile')::integer
    ) as PresJuv,
    toc.data->>'effectif' as Effectif,
    toc.data->>'nb_juvenils' as NbJuv,
    string_agg(
