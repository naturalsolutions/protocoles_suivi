DROP VIEW IF EXISTS gn_monitoring.v_export_efficacite_observateur_observations;
CREATE OR REPLACE VIEW gn_monitoring.v_export_efficacite_observateur_observations as
select tm.module_code as protocole,
    ...
    ref_nomenclatures.get_nomenclature_label(
        (toc.data->>'id_nomenclature_type_leurre')::integer
    ) as TypeLeurre,
    ref_nomenclatures.get_nomenclature_label(
        (toc.data->>'id_nomenclature_couleur_leurre')::integer
    ) as CouleurLeurre,
    ref_nomenclatures.get_nomenclature_label(
        (toc.data->>'id_nomenclature_efficacite')::integer
    ) as Efficacite,
    ref_nomenclatures.get_nomenclature_label(
        (toc.data->>'id_nomenclature_presence_foret')::integer
    ) as PresForet,
    toc.data->>'taille' as taille,
    toc.data->>'hauteur_veg' as hauteurVeg,
    toc.data->>'numero_leurre' as idLeurre,
    string_agg(
